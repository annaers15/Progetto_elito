      ...
      <div class="row">
        <div class="col lg-4">
          ...
          <div class="icon">
            ...
            <!-- vimeo -->
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-vimeo"
              viewBox="0 0 16 16">
              <path
        ...
        <div class="col lg-4">
          ...
          <div class="input-group mb-3">
            <input type="email" class="form-control" placeholder="Email Address *" aria-label="Recipient's email"
              aria-describedby="button-addon">
            <button class="btn secondary" type="button" id="button-addon2"><a href="#"><svg
...
.green-shadow {
  background-image: radial-gradient(circle, #59c3794c, #46513e29, #2020203f);
}
